<%@ page import="com.project.iacontent.model.Administrator" %>
<%--
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form action="<%= request.getContextPath() %>/addContents" method="post">
                                        <div class="input-group mb-3">
                                            <input name="title" type="text" class="form-control" placeholder="Titre" aria-label="Titre" aria-describedby="basic-addon2">
                                        </div>
                                        <div class="input-group mb-3">
                                            <textarea name="content"></textarea>
                                        </div>
                                        <input type="hidden" name="idAdmin" value="<%= administrator.getId() %>" />
                                        <div class="input-group mb-3">
